...
# **Diese Version lädt nur die Seite. Keine Callbacks.**
######
import dash
...
res = requests.get(url, headers={'User-Agent': 'Mozilla/5.0'})  # Ein falscher Header ist nötig, um auf die Seite zuzugreifen
data = res.json()
counter = 0
