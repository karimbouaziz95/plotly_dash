...
# welches hoverData via Callback an einen anderen Graphen und 
# an eine Markdown-Komponente mittels einem zweiten Callback schickt.
######
import dash
...
app.layout = html.Div([
    ...
    html.Div([  # # Dieses Div enthält unseren Ausgabegraphen und Fahrzeugstatistiken
    dcc.Graph(
        id='mpg_line',
        figure={
            'data': [go.Scatter(
